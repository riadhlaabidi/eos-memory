...
\begin{table}[hbt!]
      ...
      \begin{tabularx}{\textwidth}{ |
            ...
            \hline
            \textbf{C2} \linebreak Deliverability         & Low \acrfull{ctr} that drops over time due to inactive receivers leading to misinformation for senders about the deliverability of notifications. & Calculated accurately for each type, relies on operating systems events        &                                                                           \\
            \hline
            ...
            \\
            \hline
            \textbf{C5} \linebreak Analytics              & Provides insights dashboard                                                                                                                       & Provides simple metrics, relies on third party services for in-depth analytics & No detailed insights on sent notifications                                \\
            \hline
