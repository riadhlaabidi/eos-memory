...
A notification is a message, email, icon, or another symbol that appears when an application wants
a user to pay attention to something. These notifications can take various forms, including
text-based messages which are plain text messages suitable for conveying essential information
concisely, and image notifications which incorporate graphics, pictures, effective for
providing visual instructions.

In modern communication strategies, different types of notifications serve specific purposes in
reaching users efficiently. Common notification types are:

\begin{itemize}
      \item \textbf{Email notifications}: These are messages sent electronically via email, ideal for
            asynchronous communication, and delivering detailed updates and information.
      \item \textbf{Push notifications}: These are short messages that appears as a pop-up on a desktop
            browser, or a mobile home screen. Push notifications display text and rich media, like images or
            buttons, which enable a user to take a specific action. Ideal for providing instant updates and
            information directly to users' screens.
      \item \textbf{SMS Notifications}: These are limited-length concise text messages sent to mobile
            phones, which are suitable for delivering direct and often time-sensitive messages.
      \item \textbf{Chat Notifications}: These are text and rich-media alerts within messaging apps or
            chat platforms. They enable interactive communication, allowing businesses to engage in quick
            and convenient exchanges with customers.
\end{itemize}

A notification center is a system that allows businesses to send and manage these types of
notifications to their customers or employees. The value proposition of a notification center
is that it can help businesses communicate with their stakeholders more efficiently and
effectively, leading to increased engagement and productivity.

In the retail sector as an example, a company could use the notification center to send SMS, email, push
or chat alerts about product recalls, special promotions, or other important information to customers.
By using a notification center, businesses can improve communication with their customers and ensure
that important information is quickly and effectively distributed.
...
\subsubsection{OneSignal \cite{onesignal}}
...
\subsubsection{Pusher \cite{pusher}}
...
\subsubsection{Amazon SNS \cite{aws-sns}}
...
\begin{itemize}
      ...
      \item \textbf{C5: Analytics:} The ability to track different metrics during the delivery process
            in order to inform businesses about the effectiveness of notification campaings.
...
\noindent The table \ref{comparison} describes our findings comparing the selected existing solutions.
...
\noindent The figure \ref{solution} illustrates the main idea for our proposed solution.
