...
\begin{figure}[hbt!]
      \centering
      \includesvg[width=\textwidth]{app/monolithic}
...
% The backend application code has a REST-API implemented. This acts as an interface to the outside world
% requests. Every request, be it from the client written by the business or the third-party developers,
% those who consume our API data have to hit the REST endpoints to fetch the data.
...
\begin{table}[hbt!]
      \begin{tabular}{ | m{0.2\textwidth} | m{0.795\textwidth} | }
            \hline
