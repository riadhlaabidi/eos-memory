...
of the project. The primary focus will be on the application architecture.

Additionally, we will elaborate on the curated set of tools and frameworks that were employed to support
and streamline the development workflow.



\subsection{Software architecture}
The chosen architecture for the web application is a monolithic approach, where all the application
modules and components are tightly integrated into a single codebase. This decision was based on
several factors such as the project's scope, timeline, and the team's familiarity with monolithic
architectures. Furthermore, for the envisioned requirements, a monolithic design offered simplicity
